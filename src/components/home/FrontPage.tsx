...
const FrontPage = () => {
  ...
  return (
    <div
      className={`background-div relative grid ${
      ...
      <div className="flex space-y-8 flex-col  ">
        ...
        <div>
          <p className=" frontpage-text">
            Pneuma Impact has helped entrepreneurs with an idea to start a
            business while providing them skills, mentorship, and funds to get
            started.
          </p>
        </div>
        <div className="flex flex-col space-y-5 md:flex-row md:space-x-5 md:space-y-0 ">
          <Button variant="noBg" color="primary" style={homeButtonStyle} href='/signup'>
            Get Started
          </Button>
