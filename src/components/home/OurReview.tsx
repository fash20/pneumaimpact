    ...
    <div className="relative flex flex-col justify-center items-center ">
      <div className="grid">
        ...
        <div className="flex z-0 flex-col relative justify-center items-center h-[700px] ">
          <StudentReview
            testimonial={Testimonials[testimonialCount]}
  ...
  return (
    ...
    >
      <div className="relative md:absolute flex font-extrabold items-center justify-center h-[100px] md:left-16 text-[130px] text-[#DBDAFF] ">
        {/* <img style={{ maxHeight: "100%" }} src={numberOne} /> */}0
        {count + 1}
      </div>
      <div className="flex flex-col items-center justify-center gap-y-5 mt-[5px]">
        {/* <img src={testimonial.img} className="avatar2" style={{ height: 100, width: 100, borderRadius:'50%' }} /> */}
        {/* <img
        ...
        <p
          id="fade-in"
          className="font-zcool text-md h-[220px] mb:h-[200px] md:h-[160px] lg:h-[100px] "
        >
          {testimonial.review}
        </p>
      </div>
